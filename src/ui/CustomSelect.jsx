        ...
        <div className="relative h-11 sm:h-[52px]">
          <Listbox.Button className="w-full h-full text-secondary-200 border border-secondary-600 rounded-xl pl-3 pr-10 text-left shadow-modal-btns focus:outline-none focus:ring-1 focus:ring-primary-200 focus:border-primary-200">
            ...
            {selectedOption ? (
              ...
              <span className="text-sm xl:text-base text-secondary-300">
                {placeholder}
              </span>
            )}
          </Listbox.Button>
            ...
            >
              {options.map((option) => (
                <Listbox.Option
                  ...
                  value={option.value}
                  className={({ active }) =>
                    `cursor-pointer px-4 py-2 text-xs xl:text-base font-black text-secondary-100 bg-secondary-800 hover:bg-primary-50 hover:text-black ${
