...
function SearchFilter({ placeholder, className, value, onChange }) {
  return (
    ...
    >
      <IoIosSearch className="w-9 h-9 sm:w-10 sm:h-10 pl-2 sm:pl-4 text-secondary-400" />
      <input
        className="text-sm sm:text-base appearance-none w-full bg-transparent h-11 sm:h-[50px] text-left border-none focus:outline-none shadow-none placeholder-secondary-400"
        type="text"
